...
public class MainListsS {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException{
        ...
        while( FileParsers.hasNextEvent() ){
            ...
            if(event.getOperation().equals("I")){ // operation
            	...
            	if(sortedList.movieExists(event.getMovieId())){  //h tainia yparxei
            		System.out.println("Success ["+sortedList.get(event.getMovieId()).getTitle()+"]"); 
    ...
    while(aaaaa){
    	...
    	if(fun==1){
            ...
            long currTime1 = System.currentTimeMillis();
            while(node !=null){
            	dur+=sortedList.get(node.getMovieId()).getDuration();
            	node=node.getNext();	
            }
            long endTime1 = System.currentTimeMillis();
            ...
            while(user1 != null){
            	...
            	while(movie !=null){
            		if(sortedList.get(movie.getMovieId()).getGenres().contains(eidos)){
            			counter++;
            		}
            		movie=movie.getNext();
            	}
