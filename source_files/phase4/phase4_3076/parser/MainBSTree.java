...
public class MainBSTree{ 
    ...
    private static final String moviesInputFilePath = "C:\\Users\\dona\\Desktop\\java\\project\\movies_full.txt";//39 movies (vaggi)
      ...
      //menu
        ...
        while(aaaaa){
        	...
        	if(fun==1){
        		...
        		String temp=null;
            	double  rank=( ( ( tree.getRoot().getVotes()*tree.getRoot().getRating() )+( 25000.0+6.9 ) )/( tree.getRoot().getVotes() + 25000.0) );
        		double max=rank;
