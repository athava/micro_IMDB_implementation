       ...
       System.out.println("time passed: "+ (endTime-currTime)+" ms");
        ...
        while( FileParsers.hasNextEvent() ){
            ...
            if(event.getOperation().equals("I")){ 
            	...
            	if(sortedHash.movieExists(event.getMovieId())){  
            		System.out.println("Success ["+sortedHash.get(event.getMovieId()).getTitle()+"]"); 
      ...
      //menu
        ...
        while(aaaaa){
        	...
        	if(fun==1){
                ...
                for(int k=0; k<sortedHash.getTableSize(); k++){
                ...
                long currTime1 = System.currentTimeMillis();
                while(node !=null){
                	dur+=sortedHash.get(node.getMovieId()).getDuration();
                	node=node.getNext();	
                }
                ...
                while(user1 != null){
                	...
                	while(movie !=null){
                		if(sortedHash.get(movie.getMovieId()).getGenres().contains(eidos)){
                			counter++;
                		}
                		movie=movie.getNext();
                	}
